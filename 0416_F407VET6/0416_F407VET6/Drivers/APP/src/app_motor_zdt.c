...
{
    Emm_V5_Pos_Control(_addr, _dir, _vel, _acc, _clk, _raF, _snF);
    HAL_Delay(pdMS_TO_TICKS(2));
}
...
*********************************************************************************************************
*/
void APP_MOTOR_ZDT_WaitAck(uint8_t _addr, uint32_t timeout)
{
    can_WaitAck(_addr, timeout);
}

/*
*********************************************************************************************************
*    函 数 名: APP_MOTOR_ZDT_SetAckId
*    功能说明: 设置电机应答Id
*    形    参: _addr
*    返 回 值: 无
*********************************************************************************************************
