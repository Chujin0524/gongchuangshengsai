...
static uint16_t s_AnglePlate_R = 870;   //转盘角度  红色物块存放位置
static uint16_t s_AnglePlate_G = 655;   //转盘角度  绿色物块存放位置
static uint16_t s_AnglePlate_B = 1080;  //转盘角度  蓝色物块存放位置
static uint16_t s_AngleJaw_Z   = 640;     //夹爪角度  抓紧物块
static uint16_t s_AngleJaw_S   = 1000;     //夹爪角度  松开物块
...
static uint16_t s_AngleJaw   = 1000;  //夹爪初始角度
