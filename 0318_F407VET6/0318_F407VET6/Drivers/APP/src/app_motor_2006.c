...
{
    static uint32_t clk1 = 150000;
    static uint32_t clk2 = 5000;
    static double v_max = 500;
    static double v_min = 25;
    int flag = 0;
    Weak_mode = 0;
    if( flag == 0 )
    {
