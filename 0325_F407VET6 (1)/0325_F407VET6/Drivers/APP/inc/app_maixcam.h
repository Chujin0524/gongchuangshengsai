...
typedef struct
{
    ...
    uint16_t usRedCircleCenter_X;       //红色环区中心点X
    uint16_t usRedCircleCenter_Y;       //红色环区中心点Y
    uint16_t usGreenCircleCenter_X;     //绿色环区中心点X
    uint16_t usGreenCircleCenter_Y;     //绿色环区中心点Y
    uint16_t usBlueCircleCenter_X;      //蓝色环区中心点X
    uint16_t usBlueCircleCenter_Y;      //蓝色环区中心点Y
