...
static uint16_t MOTOR_W_Vel = 100;
...
转盘位置 :
*/
static uint8_t MOTOR_R_Acc = 100;
...
X位置 :
*/
static uint8_t MOTOR_X_Acc = 100;
...
//Y位置
static uint8_t MOTOR_Y_Acc = 230;
static uint16_t MOTOR_Y_Vel = 500;
...
//    APP_MOTOR_ZDT_WaitAck(MOTOR_W);
    ...
    //腕处舵机朝前
    APP_MOTOR_ZDT_Move_P(MOTOR_W, MOTOR_W_Direction_CCR,     MOTOR_W_Vel, MOTOR_W_Acc, MOTOR_W_Pos[FORWARD_W], 1, 0);
    APP_MOTOR_ZDT_WaitAck(MOTOR_W);
...
void APP_Handle_Run(void)
{
    ...
    APP_MOTOR_ZDT_Move_P(MOTOR_W, MOTOR_R_Direction_CCR,     MOTOR_W_Vel, MOTOR_W_Acc, 0, 1, 0);
    //    APP_SERVO_Wrist('R');
    APP_MOTOR_ZDT_WaitAck(MOTOR_Y);
//    APP_MOTOR_ZDT_WaitAck(MOTOR_X);
//    APP_MOTOR_ZDT_WaitAck(MOTOR_R);
...
////    APP_MOTOR_ZDT_WaitAck(MOTOR_X);
////    APP_MOTOR_ZDT_WaitAck(MOTOR_R);
//    APP_MOTOR_ZDT_Move_P(MOTOR_W, MOTOR_R_Direction_CCR,     MOTOR_W_Vel, MOTOR_W_Acc, MOTOR_W_Pos[LEFT_W], 1, 0);
//    vTaskDelay(1000);
...
//    APP_MOTOR_ZDT_WaitAck(MOTOR_X);
//    APP_MOTOR_ZDT_WaitAck(MOTOR_R);
    APP_MOTOR_ZDT_Move_P(MOTOR_W, MOTOR_R_Direction_CCR,     MOTOR_W_Vel, MOTOR_W_Acc, MOTOR_W_Pos[FORWARD_W], 1, 0);
    APP_MOTOR_ZDT_WaitAck(MOTOR_Y);
}
