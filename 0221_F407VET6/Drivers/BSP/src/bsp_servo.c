...
static uint16_t s_AngleJaw_Z   = 640;     //夹爪角度  抓紧物块
static uint16_t s_AngleJaw_S   = 950;     //夹爪角度  松开物块
static uint16_t s_AngleWrist_F = 1160;      //腕处角度  朝前
static uint16_t s_AngleWrist_R = 640;       //腕处角度  朝右

static uint16_t s_AngleJaw   = 0;  //转盘初始角度
static uint16_t s_AngleWrist = 0;  //夹爪初始角度
static uint16_t s_AnglePlate = 0;  //腕处初始角度
