...
void M2006_CAL()
{
    ...
    angle_r = ( moto_chassis[0].angle - moto_chassis[1].angle - moto_chassis[2].angle + moto_chassis[3].angle ) / 4;
    angle_dia = (-moto_chassis[0].angle - moto_chassis[1].angle + moto_chassis[2].angle + moto_chassis[3].angle ) / 4;
}
