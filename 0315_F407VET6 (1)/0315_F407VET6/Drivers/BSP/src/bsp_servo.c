...
static uint16_t s_AnglePlate_R = 350;   //转盘角度  红色物块存放位置
static uint16_t s_AnglePlate_G = 780;   //转盘角度  绿色物块存放位置
static uint16_t s_AnglePlate_B = 1250;  //转盘角度  蓝色物块存放位置
static uint16_t s_AngleJaw_Z   = 250;     //夹爪角度  抓紧物块
static uint16_t s_AngleJaw_S   = 500;     //夹爪角度  松开物块
static uint16_t s_AngleWrist_F = 1150;      //腕处角度  朝前
static uint16_t s_AngleWrist_R = 630;       //腕处角度  朝右

//static uint16_t s_AngleJaw   = 500;  //转盘初始角度
static uint16_t s_AngleJaw   = 500;  //夹爪初始角度
static uint16_t s_AngleWrist = 1150;  //腕处初始角度
static uint16_t s_AnglePlate = 0;  //转盘初始角度
