...
void AppTask_Chassis(void *argument);
...
void MX_FREERTOS_Init(void) {
  ...
  Task_ChassisHandle = osThreadNew(AppTask_Chassis, NULL, &Task_Chassis_attributes);
...
/* USER CODE BEGIN Header_AppTask_Chassis */
/**
* @brief Function implementing the Task_Chassis thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_AppTask_Chassis */
__weak void AppTask_Chassis(void *argument)
{
  /* USER CODE BEGIN AppTask_Chassis */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END AppTask_Chassis */
}
