...
static uint32_t MOTOR_R_Pos[4] = {0, 6000, 3750, 1500};  
...
static uint32_t MOTOR_X_Pos[4] = {2900, 6500, 3800, 7500};    
...
static uint16_t MOTOR_Y_Vel = 100; 
//static uint32_t MOTOR_Y_Pos[8] = {0, 300, 0, 1600, 9000, 6000, 8000, 0}; 
static uint32_t MOTOR_Y_Pos[8] = {0, 0, 0, 1600, 9000, 6000, 8000, 0}; 
