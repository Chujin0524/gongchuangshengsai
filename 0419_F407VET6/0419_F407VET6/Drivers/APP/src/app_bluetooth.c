...
//        APP_MOTOR_ZDT_Move_P(s_MotorZDT_ID, s_MotorZDT_DIR, 800, 0, s_MotorZDT_POS, 1, 0);
        APP_MOTOR_ZDT_Move_P(s_MotorZDT_ID, s_MotorZDT_DIR, 200, 50, s_MotorZDT_POS, 1, 0);
    ...
    else if (strncmp((char *)pucFrameData, "Handle_Test=", 12) == 0)
    {
        ...
        {
            case 1:
                APP_Handle_Place_All(0, RED, GREEN, BLUE);      //第一次全部放置测试
                break;

            case 2:
                APP_Handle_Place_All(1, RED, GREEN, BLUE);      //第二次全部放置测试
                break;
            ...
            case 12:
                APP_Handle_Place_One(GREEN, RED);
            ...
            case 16:                  //放所有测试
                APP_SERVO_Plate(RED);
                vTaskDelay(500);
                APP_Handle_Place_All(0, RED, BLUE, GREEN);
                break;

            case 17:                  //放所有测试
                APP_SERVO_Plate(RED);
                vTaskDelay(500);
                APP_Handle_Place_All(1, RED, GREEN, BLUE);
                break;

            case 18:                  //抓所有测试
                APP_Handle_Pick_All(RED, GREEN, BLUE);
                break;
