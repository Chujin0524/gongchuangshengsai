...
typedef enum
{
    ...
    MAIXCAM_STATUS_Blob_WaitGrab,           //3
    MAIXCAM_STATUS_Blob_WaitGrab2,          //4
    MAIXCAM_STATUS_Blob_WaitGrab3,          //5
    MAIXCAM_STATUS_Circle_CalCar,           //6
    MAIXCAM_STATUS_Circle_CalXR,            //7
} MAIXCAM_STATUS_E;
...
typedef struct
{
    ...
    uint16_t usPresentX;              //当前圆心X
    uint16_t usPresentY;              //当前圆心Y
    uint16_t usPreviousX;              //上一次圆心X
    uint16_t usPreviousY;              //上一次圆心Y
...
extern MAIXCAM_DATA_T s_tMaixCAM_Data;
