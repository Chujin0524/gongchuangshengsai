...
typedef enum
{
    ...
    STATUS_RawAreaPlace = 22,

    STATUS_RawArea_2_ProFirArea = 3,      //从原料区到粗加工区
    STATUS_RawArea_2_ProFirArea_1 = 32,      //从原料区到粗加工区_1
    STATUS_ProFirArea_2_RawArea_1 = 33,      //从粗加工区到原料区_1
    STATUS_RawArea_2_ProFirArea_2 = 34,      //从原料区到粗加工区_2
    STATUS_ProFirArea_2_RawArea_2 = 35,      //从粗加工区到原料区_2
    STATUS_ProFirAreaCalAndPlace = 36,    //粗加工区校准和放置
    STATUS_ProFirAreaGrab = 37,           //粗加工区抓取

    STATUS_ProFirArea_2_ProSecArea = 4,   //从粗加工区到细加工区
    STATUS_ProFirArea_2_ProSecArea_2 = 42,   //从粗加工区到细加工区
    STATUS_ProFirArea_2_ProSecArea_3 = 43,   //从粗加工区到细加工区
