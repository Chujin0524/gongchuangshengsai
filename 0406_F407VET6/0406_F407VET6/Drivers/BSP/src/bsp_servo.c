...
static uint16_t s_AnglePlate_R = 750;   //转盘角度  红色物块存放位置
static uint16_t s_AnglePlate_G = 1210;   //转盘角度  绿色物块存放位置
static uint16_t s_AnglePlate_B = 310;  //转盘角度  蓝色物块存放位置
static uint16_t s_AngleJaw_Z   = 800;     //夹爪角度  抓紧物块
static uint16_t s_AngleJaw_S   = 1050;     //夹爪角度  松开物块
static uint16_t s_AngleJaw_S2   = 1150;     //夹爪角度  松开物块
