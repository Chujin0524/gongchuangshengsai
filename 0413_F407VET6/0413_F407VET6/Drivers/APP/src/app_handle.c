...
uint32_t MOTOR_Y_Pos[9] =
{
    ...
    100,        //2 : 夹着物块能越过转盘的位置
    2600,     //3 : 夹着物块放到转盘上的位置
    11500,    //4 : 夹着物块放到色环上的位置
    6000,     //5 : 码垛物块的位置
    8300,     //6 : 物块在色环上，夹爪能越过的位置
    0,        //7 :
    5100,     //8 : 从转盘区夹起物块的位置
};
...
//            //Y4：夹着物块放到色环上的位置
//            APP_MOTOR_ZDT_Move_P(MOTOR_Y, MOTOR_Y_Direction_DOWN, 100, 170, MOTOR_Y_Pos[4], 1, 0);
//            APP_MOTOR_ZDT_WaitAck(MOTOR_Y, MOTOR_Y_Timeout);
            //Y4：夹着物块放到色环上的位置
            APP_MOTOR_ZDT_Move_P(MOTOR_Y, MOTOR_Y_Direction_DOWN, MOTOR_Y_Vel[0], MOTOR_Y_Acc[0]-10, MOTOR_Y_Pos[4], 1, 0);
            APP_MOTOR_ZDT_WaitAck(MOTOR_Y, MOTOR_Y_Timeout);
        }
        else if (_ucCycle == 1)
        {
...
//        APP_SERVO_Jaw('S');     //夹爪舵机松开物块
        ...
        APP_MOTOR_ZDT_WaitAck(MOTOR_Y, 800);
        ...
        //腕处舵机朝右
        APP_MOTOR_ZDT_Move_P(MOTOR_W, MOTOR_W_Direction_CCR,     MOTOR_W_Vel, MOTOR_W_Acc[1], MOTOR_W_Pos[RIGHT_W], 1, 0);
        APP_MOTOR_ZDT_WaitAck(MOTOR_W, MOTOR_W_Timeout);
...
//            APP_MOTOR_ZDT_WaitAck(MOTOR_X, MOTOR_X_Timeout);
//            APP_MOTOR_ZDT_WaitAck(MOTOR_R, MOTOR_R_Timeout);
//            APP_MOTOR_ZDT_WaitAck(MOTOR_W, 200);
        }
    }
...
void APP_Handle_Run(void)
{
    APP_MOTOR_ZDT_Move_P(MOTOR_Y, MOTOR_Y_Direction_DOWN,    MOTOR_Y_Vel[1], MOTOR_Y_Acc[1], MOTOR_Y_Pos[0], 1, 0);
    APP_MOTOR_ZDT_Move_P(MOTOR_R, MOTOR_R_Direction_CCR,     MOTOR_R_Vel, MOTOR_R_Acc, MOTOR_R_Pos[MIDDLE], 1, 0);
    APP_MOTOR_ZDT_Move_P(MOTOR_X, MOTOR_X_Direction_FORWARD, MOTOR_X_Vel, MOTOR_X_Acc, 5200, 1, 0);
