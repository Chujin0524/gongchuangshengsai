...
static uint16_t s_AnglePlate_R = 800;   //转盘角度  红色物块存放位置
static uint16_t s_AnglePlate_G = 350;   //转盘角度  绿色物块存放位置
static uint16_t s_AnglePlate_B = 1240;  //转盘角度  蓝色物块存放位置
static uint16_t s_AngleJaw_Z   = 890;     //夹爪角度  抓紧物块
//static uint16_t s_AngleJaw_S   = 1050;     //夹爪角度  松开物块
static uint16_t s_AngleJaw_S   = 1130;     //夹爪角度  松开物块
static uint16_t s_AngleJaw_S2   = 1130;     //夹爪角度  松开物块
