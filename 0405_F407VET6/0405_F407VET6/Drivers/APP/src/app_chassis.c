...
void chassis_control_vector(float* vx_set, float* vy_set, chassis_move_t* chassis_move)
{
    ...
    float dis_dec_k = 0.83;     //减速距离的系数，行走到dis_dec_k*dis_set之后，开始减速
...
void APP_CHASSIS_Status(STATUS_E _ucStatus)
{
    switch (_ucStatus)
    {
        ...
        case STATUS_Qr_2_RawArea:
            APP_CHASSIS_MovePID(CHASSIS_LONG, CHASSIS_CALL_BLOCKING, CarDirection_Forward, 900);
            break;
        ...
        case STATUS_ProFirArea_2_ProSecArea:
            ...
            APP_CHASSIS_MovePID(CHASSIS_LONG, CHASSIS_CALL_BLOCKING, CarDirection_Left, 850);
            APP_CHASSIS_MovePID(CHASSIS_LONG, CHASSIS_CALL_BLOCKING, CarDirection_Rotate, 90);       //夹爪朝向90度
            break;

        case STATUS_ProSecArea_2_RawArea:
            APP_CHASSIS_MovePID(CHASSIS_LONG, CHASSIS_CALL_BLOCKING, CarDirection_Backward, 950);
            APP_CHASSIS_MovePID(CHASSIS_LONG, CHASSIS_CALL_BLOCKING, CarDirection_Left, 350);
